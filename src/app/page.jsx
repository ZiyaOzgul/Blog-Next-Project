...
const Home = () => {
  const videoSource = "/assets/homePageBg.mp4";
  ...
  return (
    <div className="w-full h-auto flex flex-col items-center justify-start mt-4 font-helvetica">
      <div className="w-full h-35v my-12 border-t border-t-black">
        <video
          muted
          autoPlay
          loop
